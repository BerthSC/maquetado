                        ...
                        <div class="collapse" id="usuariosMenu">
                            <ul class="nav flex-column submenu">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="fas fa-search"></i> Documentos Usuario
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="asambleasMenu">
                            <ul class="nav flex-column submenu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="fas fa-calendar-alt"></i> Acta de Asableas
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="utilidadesMenu">
                            <ul class="nav flex-column submenu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
                                        <i class="fas fa-money-bill-trend-up"></i> Distribuir
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">
